...
import { updateInvoiceLineItemAction } from "@/lib/invoices/invoice-actions";
...
export function EditLineItemDialog({
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      const result = await updateInvoiceLineItemAction(undefined, formData);
      if (result?.ok) {
        setOpen(false);
        setError(null);
        router.refresh();
